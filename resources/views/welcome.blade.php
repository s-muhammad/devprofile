...
<header id="siteHeader" class="sticky top-0 z-50 bg-white/85 backdrop-blur border-b border-[var(--border)] transition-shadow">
    <div class="max-w-[1320px] mx-auto px-6 lg:px-14 flex items-center justify-between h-[72px]">
        ...
        <nav class="hidden md:flex items-center gap-10 text-sm font-medium text-[var(--muted)]">
            <a href="#skills" class="nav-link hover:text-[var(--ink)] transition-colors py-1">مهارت‌ها</a>
            <a href="#projects" class="nav-link hover:text-[var(--ink)] transition-colors py-1">پروژه‌ها</a>
            <a href="#articles" class="nav-link hover:text-[var(--ink)] transition-colors py-1">مقالات</a>
...
{{--                در دسترس--}}
{{--            </div>--}}
            <a href="#contact" class="hidden md:inline-block btn-primary text-white text-sm font-bold px-5 py-2.5 rounded-full">شروع همکاری</a>
    ...
    <div id="mobileMenu" class="md:hidden border-t border-[var(--border)]">
        <nav class="flex flex-col px-6 py-4 gap-1 text-sm font-medium">
            <a href="#skills" class="py-2.5 text-[var(--muted)] hover:text-[var(--ink)]">مهارت‌ها</a>
            <a href="#projects" class="py-2.5 text-[var(--ink)] hover:text-[var(--ink)]">پروژه‌ها</a>
            <a href="#articles" class="py-2.5 text-[var(--muted)] hover:text-[var(--ink)]">مقالات</a>
{{--            <a href="#about" class="py-2.5 text-[var(--muted)] hover:text-[var(--ink)]">درباره من</a>--}}
            <a href="#contact" class="btn-primary text-white text-sm font-bold px-5 py-3 rounded-full text-center mt-2">شروع همکاری</a>
        </nav>
    </div>
</header>

<!-- HERO -->
<section class="max-w-[1320px] mx-auto px-6 lg:px-14 pt-14 md:pt-20 pb-20 grid md:grid-cols-2 gap-14 items-center overflow-hidden">
    <div class="text-center md:text-right order-2 md:order-1">
        <span class="pill inline-block text-xs font-bold px-4 py-1.5 rounded-full mb-6">در دسترس برای پروژه‌های جدید</span>
        <h1 class="text-4xl md:text-[52px] font-extrabold leading-[1.35] mb-6">
            ایده‌ی شما را با <span class="text-[var(--accent)]">Laravel</span> به محصولی <span class="text-[var(--accent)]">واقعی</span> تبدیل می‌کنم
        </h1>
        <p class="text-base md:text-lg text-[var(--muted)] leading-8 mb-9 max-w-lg mx-auto md:mx-0">
            توسعه‌دهنده‌ی متمرکز بر اکوسیستم لاراول؛ از پایه‌ی دیتابیس تا رابط کاربری زنده با Livewire، کدی تمیز و مقیاس‌پذیر تحویل می‌دهم.
        </p>
        <div class="flex flex-wrap items-center justify-center md:justify-start gap-4">
            <a href="#projects" class="btn-primary text-white px-7 py-3.5 rounded-full font-bold text-sm">نمونه‌کارها را ببینید</a>
            <a href="#articles" class="border border-[var(--border)] px-7 py-3.5 rounded-full font-bold text-sm hover:bg-[var(--bg-soft)] transition-colors">مقالات فنی</a>
        </div>
    </div>
    ...
    <div class="relative order-1 md:order-2 h-[340px] md:h-[420px] hidden md:block">
        ...
        <div class="mock-frame absolute inset-x-4 top-6 md:top-10 shadow-xl">
            ...
            <div class="p-5">
                ...
                <div class="flex items-center justify-between mb-6">
                    ...
                    <div class="hidden sm:flex items-center gap-3 text-[8px] font-bold text-[var(--muted)] whitespace-nowrap">
                        <span class="text-[var(--ink)] relative">محصولات<span class="absolute -bottom-1.5 inset-x-0 h-[1.5px] bg-[var(--accent)]"></span></span>
                        <span>تخفیف‌ها</span>
                        <span>تماس</span>
                    </div>
                    <div class="relative w-6 h-6 rounded-full bg-[var(--bg-soft)] flex items-center justify-center shrink-0">
                        <span class="text-[9px]">🛒</span>
                        <span class="absolute -top-0.5 -left-0.5 w-2.5 h-2.5 rounded-full bg-[var(--accent)] text-white text-[6px] flex items-center justify-center">۲</span>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-5 gap-4 items-center">
                    <div class="col-span-3 flex flex-col gap-2">
                        <span class="inline-flex w-fit text-[6.5px] font-bold px-2 py-1 rounded-full bg-[#FFF1EC] text-[#FF6B4A] whitespace-nowrap">۳۰٪ تخفیف ویژه امروز</span>
                        ...
                        <div class="flex items-center gap-2 mt-1.5">
                            ...
                            <span class="text-[9px] font-extrabold text-[var(--accent)] whitespace-nowrap">۴۹۰,۰۰۰ت</span>
                        </div>
                    </div>
                    <div class="col-span-2 relative">
                        <div class="thumb-1 rounded-xl h-32 relative overflow-hidden flex items-center justify-center">
                        ...
                        <div class="absolute -bottom-3 -left-3 bg-white rounded-lg shadow-md border border-[var(--border)] px-2.5 py-1.5 flex items-center gap-1 whitespace-nowrap">
        ...
        <!-- floating badge: tech -->
        <div class="float-card absolute -bottom-2 -right-2 md:right-4 bg-white rounded-2xl shadow-lg border border-[var(--border)] px-4 py-3 flex items-center gap-3" style="--r:-2deg; animation-delay:.2s;">
            <div class="w-8 h-8 rounded-full bg-[var(--accent-soft)] flex items-center justify-center text-[var(--accent)] text-xs font-bold">LW</div>
            <div>
        ...
        <!-- floating badge: tech -->
        <div class="float-card absolute top-2 -left-2 md:-left-6 bg-white rounded-2xl shadow-lg border border-[var(--border)] px-4 py-3 flex items-center gap-3" style="--r:2deg; animation-delay:1s;">
            <div class="w-8 h-8 rounded-full bg-[#E9FBF0] flex items-center justify-center text-[#1FA971] text-xs font-bold">DB</div>
            <div>
        ...
        <!-- floating chip -->
        <div class="float-card absolute bottom-16 left-0 md:-left-4 bg-[var(--ink)] text-white rounded-full shadow-lg px-4 py-2 mono text-[11px] font-bold" dir="ltr" style="--r:-3deg; animation-delay:1.6s;">
            PHP 8.x
        </div>
    </div>
</section>
...
<section id="skills" class="max-w-[1320px] mx-auto px-6 lg:px-14 py-16">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <div class="reveal card p-6">
            <div class="w-11 h-11 rounded-xl thumb-4 flex items-center justify-center text-white font-bold text-sm mb-5">PHP</div>
            <h3 class="font-bold mb-2">PHP 8.x</h3>
            <p class="text-sm text-[var(--muted)] leading-6">توسعه‌ی کدهای سمت سرور مدرن، شیءگرا و با پرفورمنس بالا.</p>
        </div>
        <div class="reveal card p-6">
            <div class="w-11 h-11 rounded-xl thumb-1 flex items-center justify-center text-white font-bold text-sm mb-5">LV</div>
            <h3 class="font-bold mb-2">Laravel</h3>
            <p class="text-sm text-[var(--muted)] leading-6">ساخت اپلیکیشن‌های پیچیده‌ی وب با فریم‌ورک محبوب لاراول.</p>
        </div>
        <div class="reveal card p-6">
            <div class="w-11 h-11 rounded-xl thumb-2 flex items-center justify-center text-white font-bold text-sm mb-5">LW</div>
            <h3 class="font-bold mb-2">Livewire</h3>
            <p class="text-sm text-[var(--muted)] leading-6">ساخت رابط کاربری داینامیک و مدرن بدون خروج از دنیای PHP.</p>
        </div>
        <div class="reveal card p-6">
            <div class="w-11 h-11 rounded-xl thumb-3 flex items-center justify-center text-white font-bold text-sm mb-5">DB</div>
            <h3 class="font-bold mb-2">MySQL</h3>
            <p class="text-sm text-[var(--muted)] leading-6">طراحی دیتابیس‌های بهینه و مدیریت روابط و کوئری‌های سنگین.</p>
        </div>
    </div>
</section>
    ...
    <div class="grid md:grid-cols-2 gap-6">
        @foreach ($projects as $project)
            @if ($project['is_featured'] ?? $project->featured)
                <a href="https://{{ $project->url }}" target="_blank" class="reveal proj-card mock-frame md:col-span-2 group">
            <div class="mock-bar flex items-center gap-1.5 px-4 py-3">
                <span class="mock-dot bg-[#FF6159]"></span>
                <span class="mock-dot bg-[#FFC02E]"></span>
                <span class="mock-dot bg-[#28C93F]"></span>
            ...
            <div class="proj-img thumb-3 h-52">
                ...
                <div class="overlay">
                    <span class="text-white text-sm font-bold flex items-center gap-2">مشاهده پروژه <span class="group-hover:-translate-x-1 transition-transform">←</span></span>
                </div>
            </div>
            <div class="p-6">
            ...
            <a href="{{ route('blog.single',$blog->id) }}">
                <article class="reveal card overflow-hidden">
                    ...
                    <div class="p-5 mt-3">
                        ...
                        <span class="text-xs text-[var(--muted)] float-left mt-2">{{ \Morilog\Jalali\Jalalian::fromCarbon($blog->created_at)->format('Y-m-d') }}</span>
...
<section id="contact" class="max-w-[1320px] mx-auto px-6 lg:px-14 py-20 scroll-mt-20">
    <div class="grid md:grid-cols-2 gap-14 items-center">
        <div class="reveal text-center md:text-right">
            ...
            <h2 class="text-3xl md:text-4xl font-extrabold mb-5 leading-[1.4]">بیایید پروژه‌ی بعدی‌تان را شروع کنیم</h2>
            <p class="text-[var(--muted)] leading-8 max-w-md mx-auto md:mx-0 mb-9">از هر کدام از راه‌های کنار می‌توانید با من در ارتباط باشید؛ معمولاً کمتر از یک روز کاری پاسخ می‌دهم.</p>
            <a href="mailto:{{ setting('site_email') }}" class="btn-primary inline-block text-white px-8 py-3.5 rounded-full font-bold text-sm">ارسال ایمیل مستقیم</a>
        </div>
        ...
        <div class="reveal mock-frame shadow-xl">
            ...
            <div class="divide-y divide-[var(--border)]">
                ...
                @foreach($socials as $social)
                    ...
                    <a href="{{ $social->value }}" target="_blank" rel="noopener" class="flex items-center gap-4 px-6 py-5 hover:bg-[var(--bg-soft)] transition-colors group">
                        <div class="w-10 h-10 rounded-xl {{ $style['bg'] }} {{ $style['text'] }} flex items-center justify-center text-base shrink-0">
                            {!! $style['icon'] !!}
                        </div>
                        ...
                        <span class="text-[var(--muted-2)] group-hover:text-[var(--accent)] group-hover:-translate-x-1 transition-all">←</span>
                    </a>
                @endforeach
            </div>
        </div>
...
<!-- FOOTER (matches blog's dark navy footer) -->
<footer class="bg-[var(--footer)] text-white mt-10">
    <div class="max-w-[1320px] mx-auto px-6 lg:px-14 py-14 flex flex-wrap items-center justify-center gap-6">
        <div class="text-center">
            <a href="/">
                <p class="font-extrabold text-xl">Dev<span class="text-[var(--accent)]">Profile</span>.ir</p>
            </a>
            <p class="text-white/40 text-xs mt-1">تمامی حقوق برای این برند محفوظ است. ۲۰۲۶</p>
        </div>
    </div>
</footer>
