            ...
            <form action="{{ route('admin.blog.update',$blog) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-6">
                    ...
                    <textarea id="summary" name="summary" rows="4"
                              class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2
                              focus-ring-blue-500 transition-colors duration-200"
                              placeholder="خلاصه کوتاهی از مقاله بنویسید" required>{{ $blog->summary }}</textarea>
                </div>
                <div class="mb-6">
                    ...
                    <textarea id="mytextarea" name="description" rows="10"
                              class="w-full px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2
                              focus:ring-blue-500 transition-colors duration-200"
                              placeholder="محتوای اصلی مقاله را وارد کنید" required>{{ $blog->description }}</textarea>
                </div>
                <div class="mb-6">
                    ...
                    <div class="flex items-center">
                        ...
                        <img src="{{asset($blog->image)}}" alt=""  class="mr-4 w-30 h-20 object-cover rounded-md shadow">
